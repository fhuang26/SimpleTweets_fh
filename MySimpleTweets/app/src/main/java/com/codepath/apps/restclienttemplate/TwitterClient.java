...
import com.codepath.apps.restclienttemplate.main.TimelineActivity;
...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "jeFKKsKQwRS2EvDQprPrCkXTe";       // Change this
	public static final String REST_CONSUMER_SECRET = "PT2WZ5V491odDbazniljEP89auimyN2WXconrCO7o08yHDGjFP"; // Change this
	...
	public void postTweet(TweetRequest request) {
		...
		client.post(apiUrl, params, new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, JSONObject jsonObj) {
				TimelineActivity.currActivity.updateTweetsAfterNewPost(jsonObj);
